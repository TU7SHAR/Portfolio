        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-y-6 mt-8 leading-7 text-zinc-400">
            <p>
              ...
              development of large applications and transpiles to JavaScript.[5]
              Because TypeScript is a superset of JavaScript, all JavaScript
              programs are syntactically valid TypeScript, but they can fail to
              type-check for safety reasons.
            </p>
            <p>
            ...
            <p>
              ...
              enables other programs to use the values defined in the files as
              if they were statically typed TypeScript entities. There are
              ...
              modules are also available, allowing development of Node.js
              programs within TypeScrip
            </p>
